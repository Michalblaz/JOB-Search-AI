...
{
    /// <summary>
    /// Odczytuje aktywne oferty pracy z bazy PostgreSQL i mapuje je na model aplikacji.
    /// </summary>
    /// <remarks>
    /// Klasa jest wykorzystywana przez <see cref="JobSearchService"/> jako szybkie źródło ofert zaimportowanych wcześniej
    /// przez proces importu. Dzięki temu aplikacja nie musi przy każdym wyszukiwaniu pytać wszystkich zewnętrznych API.
    /// </remarks>
    ...
    public class PostgresJobReader
    {
        ...
        /// <summary>
        /// Tworzy czytnik ofert na podstawie connection stringa z konfiguracji aplikacji.
        /// </summary>
        /// <param name="settingsProvider">Provider konfiguracji zawierający sekcję bazy danych.</param>
        ...
        /// <summary>
        /// Określa, czy można próbować odczytu z PostgreSQL.
        /// </summary>
        /// <value><see langword="false"/>, gdy connection string jest pusty i metoda odczytu powinna zwrócić pustą listę.</value>
        public bool IsConfigured => !string.IsNullOrWhiteSpace(_connectionString);

        /// <summary>
        /// Pobiera aktywne oferty z wybranych źródeł.
        /// </summary>
        /// <param name="selectedSources">Nazwy źródeł zaznaczonych w filtrach UI.</param>
        /// <returns>Lista ofert posortowana od najnowszych, ograniczona po stronie SQL.</returns>
        /// <remarks>
        /// Metoda mapuje nazwy wyświetlane użytkownikowi na kody źródeł w tabeli <c>job_sources</c> oraz składa języki i tagi
        /// z relacji pomocniczych do list w <see cref="JobOffer"/>.
        /// </remarks>
        ...
        private static string NormalizeEducationLabel(string? value)
        {
            ...
            return normalized switch
            {
                "WyÄąÄ˝sze" => "Wyższe",
                "ÄąĹˇrednie" => "Średnie",
                "Brak wymagaÄąâ€ž lub niewymagane" => "Brak wymagań lub niewymagane",
        ...
        private static string NormalizeExperienceLabel(string? value)
        {
            ...
            return normalized switch
            {
                "MÄąâ€šodszy specjalista" => "Młodszy specjalista",
                "MenadÄąÄ˝er" => "Menadżer",
                "Brak doÄąâ€şwiadczenia" => "Brak doświadczenia",
                _ => normalized
            };
        }
