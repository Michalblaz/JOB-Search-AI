...
{
    /// <summary>
    /// Implementacja <see cref="IUserStore"/> zapisująca konta, profile, ulubione i historię wyszukiwania w PostgreSQL.
    /// </summary>
    /// <remarks>
    /// Store sam tworzy wymagane tabele, aby aplikacja mogła wystartować na świeżej bazie. Dane ofert zapisywane przy ulubionych
    /// i historii są migawkami, dzięki czemu użytkownik nadal widzi podstawowe informacje nawet wtedy, gdy oferta zniknie ze źródła.
    /// </remarks>
    /// <seealso cref="LocalUserStore"/>
    /// <seealso cref="UserAccountRecord"/>
    public class PostgresUserStore : IUserStore
    {
        ...
        /// <summary>
        /// Tworzy store użytkowników z connection stringiem pobranym z konfiguracji.
        /// </summary>
        /// <param name="settingsProvider">Provider ustawień aplikacji.</param>
