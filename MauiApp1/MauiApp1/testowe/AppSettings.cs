...
namespace MauiApp1.testowe
{
    ...
    /// <summary>
    /// Ładuje konfigurację aplikacji z pliku pakietu i nadpisuje ją zmiennymi środowiskowymi.
    /// </summary>
    /// <remarks>
    /// Provider oddziela kod aplikacji od konkretnego miejsca przechowywania konfiguracji. Dzięki temu projekt MAUI może czytać
    /// <c>appsettings.json</c> z zasobów aplikacji, a wdrożenie webowe może przekazać sekrety przez środowisko bez zmian w kodzie.
    /// </remarks>
    /// <example>
    /// <code>
    ...
    public class AppSettingsProvider
    {
        ...
        /// <summary>
        /// Tworzy provider konfiguracji z dostawcą plików zależnym od platformy.
        /// </summary>
        /// <param name="packageFileProvider">Obiekt otwierający pliki dołączone do pakietu aplikacji.</param>
        ...
        /// <summary>
        /// Zwraca konfigurację aplikacji po zastosowaniu nadpisań środowiskowych.
        /// </summary>
        /// <returns>Ten sam, buforowany obiekt ustawień przy kolejnych wywołaniach.</returns>
